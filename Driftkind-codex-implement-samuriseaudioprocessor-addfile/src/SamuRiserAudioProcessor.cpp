...
int SamuRiserAudioProcessor::getNumPrograms()
{
    return 1;
}

int SamuRiserAudioProcessor::getCurrentProgram()
{
    return 0;
}

void SamuRiserAudioProcessor::setCurrentProgram (int)
{
}

const juce::String SamuRiserAudioProcessor::getProgramName (int)
{
    return {};
}

void SamuRiserAudioProcessor::changeProgramName (int, const juce::String&)
{
}
